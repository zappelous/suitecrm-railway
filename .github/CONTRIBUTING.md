...
This project and all community members are expected to uphold the [SuiteCRM Code of Conduct.](https://github.com/SuiteCRM/SuiteCRM/blob/master/CODE_OF_CONDUCT.md)
...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues.](https://github.com/SuiteCRM/SuiteCRM/issues)

* If you're unable to find an open issue that relates to your problem, [open a new one.](https://github.com/SuiteCRM/SuiteCRM/issues/new) Please be sure to follow the issue template as much as possible.
