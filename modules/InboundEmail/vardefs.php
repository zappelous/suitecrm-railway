...
$dictionary['InboundEmail'] = [
    ...
    'fields' => [
        ...
        'email_import_per_run_threshold' => [
            'name' => 'email_import_per_run_threshold',
            'vname' => 'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD',
            'type' => 'int',
            'len' => '11',
            'required' => false,
            'reportable' => false,
            ...
            'exportable' => false,
            'unified_search' => false,
            'comment' => 'Number of emails to import per run'
        ],
        'email_import_timeframe_start' => [
            'name' => 'email_import_timeframe_start',
            'vname' => 'LBL_EMAIL_IMPORT_TIMEFRAME_START',
            'type' => 'enum',
            'options' => 'email_import_timeframe_start_dom',
            'required' => false,
            'reportable' => false,
            'massupdate' => false,
            'inline_edit' => false,
            ...
            'exportable' => false,
            'unified_search' => false,
            'comment' => 'Timeframe start for email imports'
        ],
        'email_import_unread_only' => [
            'name' => 'email_import_unread_only',
            'vname' => 'LBL_EMAIL_IMPORT_UNREAD_ONLY',
            'type' => 'bool',
            'isnull' => true,
            'no_default' => true,
            'required' => false,
            ...
            'exportable' => false,
            'unified_search' => false,
            'comment' => 'Import only unread emails'
        ],
        'modified_user_id' => [
