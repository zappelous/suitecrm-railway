...
if (ACLController::checkAccess('AOS_Quotes', 'import', true)) {
    $module_menu[]=array("index.php?module=Import&action=Step1&import_module=AOS_Quotes&return_module=AOS_Quotes&return_action=index", $app_strings['LBL_IMPORT'],"Import", 'AOS_Quotes');
}
if (ACLController::checkAccess('AOS_Quotes', 'import', true)) {
